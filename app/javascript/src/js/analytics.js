...
window.addEventListener("DOMContentLoaded", () => {
  ...
  document
    .querySelector('[data-test-id="github-btn"]')
    ?.addEventListener("click", () => {
      if (window.location.pathname === "/sign_up") {
        _gaq.push([
          "_trackEvent",
          "sign-up_buttons",
          "click_github_sign-up button",
          "github_sign-up_button",
          1,
        ]);
        ...
        _gaq.push([
          "_trackEvent",
          "sign-in_buttons",
          "click_github_sign-in_button",
          "github_sign-in_button",
          1,
        ]);
      }
    });
  ...
  document
    .querySelector('[data-test-id="google-btn"]')
    ?.addEventListener("click", () => {
      if (window.location.pathname === "/sign_up") {
        _gaq.push([
          "_trackEvent",
          "sign-up_buttons",
          "click_google_sign-up button",
          "google_sign-up_button",
          1,
        ]);
      } else if (window.location.pathname === "/sign_in") {
        _gaq.push([
          "_trackEvent",
          "sign-in_buttons",
          "click_google_sign-in_button",
          "google_sign-in_button",
          1,
        ]);
      }
    });
  ...
  document
    .querySelector('input[value="Sign up"]')
    ?.addEventListener("click", () => {
      _gaq.push([
        "_trackEvent",
        "sign-up_buttons",
  ...
  document
    .querySelectorAll('[href^="https://www.thinkful.com/?utm_source=odin"]')
    .forEach((ad) => {
      ad.addEventListener("click", (e) => {
        adId = e.target.closest(
          '[href^="https://www.thinkful.com/?utm_source=odin"]'
        ).dataset["adId"];
  ...
  document
    .querySelectorAll("[data-complete-button-is-completed-value]")
    .forEach((complete) => {
      complete.addEventListener("click", () => {
        if (complete.dataset.completeButtonIsCompletedValue === "true") {
          ...
          complete.dataset.completeButtonIsCompletedValue === "false"
        ) {
          _gaq.push([
            "_trackEvent",
            "lesson_completion",
  ...
  document
    .querySelector('[data-test-id="next-lesson-btn"]')
    ?.addEventListener("click", () => {
      _gaq.push([
        "_trackEvent",
        "lesson_navigation",
        "click_next_lesson_link",
        "lesson_page",
        1,
      ]);
    });
